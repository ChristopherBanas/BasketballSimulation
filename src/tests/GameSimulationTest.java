...
class GameSimulationTest {
    ...
    void setUp() {
        ...
        Player dwightHoward = new Player("Dwight Howard", 35, Type.HIGH_ENERGY,
                Role.BENCH, Position.CENTER);
        Player matisseThybulle = new Player("Matisse Thybulle", 20, Type.DEFENSIVE_MINDED,
        ...
        Player tyreseMaxey = new Player("Tyrese Maxey", 20, Type.HIGH_ENERGY,
        ...
        Player lebronJames = new Player("Lebron James", 36, Type.ALL_AROUND,
                Role.STAR, Position.SMALL_FORWARD);
        Player anthonyDavis = new Player("Anthony Davis", 28, Type.PAINT_BEAST,
        ...
        Player kentPope = new Player("Pope", 30, Type.PURE_SHOOTER,
                Role.STARTER, Position.SHOOTING_GUARD);
        Player marcGasol = new Player("Marc Gasol", 38, Type.DEFENSIVE_MINDED,
                Role.STARTER, Position.CENTER);
        Player montrezHarrell = new Player("Montrez Harrell", 30, Type.HIGH_ENERGY,
